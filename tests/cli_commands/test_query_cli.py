...
def test_sample_metadata_query(CONSTANTS, logged_out_user_with_existing_config):
...
def test_bcftools_pipe_query(run_update_dimensions, logged_out_user_with_existing_config, CONSTANTS):
...
def test_bcftools_pipe_fails_on_project_not_in_config(CONSTANTS, logged_out_user_with_existing_config):
...
def test_bcftools_pipe_query_errors(
    ...
    expected_error,
    CONSTANTS,
    logged_out_user_with_existing_config,
):
    """
...
def test_get_task_status_by_task_id(CONSTANTS, logged_out_user_with_existing_config):
