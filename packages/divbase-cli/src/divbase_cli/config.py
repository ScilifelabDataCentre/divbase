...
class DivBaseCLISettings:
    ...
    DEFAULT_TOKEN_PATH: Path = Path.home() / ".config" / "divbase" / ".secrets"
    DEFAULT_DIVBASE_API_URL: str = "http://localhost:8000/api"  # TODO - change to production URL when time comes
