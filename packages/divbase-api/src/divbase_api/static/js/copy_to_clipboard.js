/*  
Makes the copy-to-clipboard buttons above any code/citation block functional.

Can handles the existence of multiple copy buttons on a single page.
*/
...
const attachClipboardListeners = () => {
  document.querySelectorAll(".clipboard").forEach((clipboardContainer) => {
    ...
    const codeBlock =
      clipboardContainer.nextElementSibling.querySelector("code");

    copyButton.addEventListener("click", () =>
      handleButtonClick(copyButton, copiedButton, codeBlock),
    );
  });
};
