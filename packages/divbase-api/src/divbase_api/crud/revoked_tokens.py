...
async def revoke_token_on_logout(db: AsyncSession, token_jti: str, user_id: int) -> RevokedTokenDB:
...
async def revoke_used_password_reset_token(db: AsyncSession, token_jti: str, user_id: int) -> RevokedTokenDB:
