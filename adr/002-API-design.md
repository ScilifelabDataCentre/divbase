...
- The API will send a lot of network requests (to/from: user, job managenemnt system and S3) so an asynchronous implementation would be ideal
...
### CLI vs webbrowser Difference:

The webbrowser would store the tokens in HttpOnly Cookies. 
