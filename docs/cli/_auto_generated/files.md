...
Download/upload/list files to/from the project&#x27;s storage bucket.
...
* `list`: list all files in the project&#x27;s storage...
* `download`: Download files from the project&#x27;s storage...
* `upload`: Upload files to your project&#x27;s storage...
* `remove`: Remove files from the project&#x27;s storage...
...
* `[FILES]...`: Space separated list of files/objects to download from the project&#x27;s bucket.
...
* `--bucket-version TEXT`: Version of the project&#x27;s storage bucket at which to download the files.
* `--project TEXT`: Name of the DivBase project, if not provided uses the default in your DivBase config file
* `-c, --config PATH`: Path to your user configuration file. By default it is stored at ~/.config/.divbase_tools.yaml.  [default: /home/roryc/.config/divbase/config.yaml]
* `--help`: Show this message and exit.
...
* `[FILES]...`: Space seperated list of files/objects in the project&#x27;s storage bucket to delete.
