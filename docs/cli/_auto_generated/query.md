...
Run queries on the VCF files stored in the project&#x27;s storage bucket. Queries are run on the DivBase API
...
* `--metadata-tsv-name TEXT`: Name of the sample metadata TSV file in the project&#x27;s storage bucket.  [default: sample_metadata.tsv]
