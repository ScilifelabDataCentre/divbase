"""
Creates an s3 client object to interact with the S3 bucket.
"""
...
def get_credentials(access_key: str | None = None, secret_key: str | None = None) -> tuple[str, str]:
    """
...
class S3FileManager:
    ...
    def download_file(self, key: str, dest: Path, bucket_name: str, version_id: str | None = None) -> None:
        """
