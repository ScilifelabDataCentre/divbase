...
def main():
    parser = argparse.ArgumentParser(description="Process bcftools commands from DivBase query config JSON")
    parser.add_argument("--config", required=True, help="Path to commands_config_structure JSON file")
